        ...
        setTimeout(() => {
            ...
            let loop = setInterval(function () {
                if ($('.Item2024--ZmwahJzV').length > 0 || $('.QJEEHAN8H5--purchasePanel--_37b78f2').length > 0) {
                    ...
                    priceNum2 = document.querySelector('.text--fZ9NUhyQ') ? document.querySelector('.text--fZ9NUhyQ') : document.querySelector('.QJEEHAN8H5--text--_4c1ce7d')
                    checkToken();
                    ...
                    if (item20242 > 0) {
                        let skuItemWrapper = $('.SkuContent--HmMiDKFt');
    ...
    function setStartPrice(priceNum2, item20242, item2025) {
        ...
        if (item20242 > 0) {
            if (!priceNum2.textContent) {
                ...
                let loop = setInterval(function () {
                    priceNum2 = document.querySelector('.originPrice--UnZ18wCd>.priceText--gdYzG_l_');
